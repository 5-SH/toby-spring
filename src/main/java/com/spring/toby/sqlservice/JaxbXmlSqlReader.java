...
public class JaxbXmlSqlReader implements SqlReader {
  ...
  public void read(SqlRegistry sqlRegistry) {
    ...
    try {
      ...
      InputStream is = UserDao.class.getClassLoader().getResourceAsStream(sqlmapFile);
      Sqlmap sqlmap = (Sqlmap) unmarshaller.unmarshal(is);
      for (SqlType sql : sqlmap.getSql()) sqlRegistry.registerSql(sql.getKey(), sql.getValue());
